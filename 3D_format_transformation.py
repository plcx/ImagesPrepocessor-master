...
if __name__ == "__main__":
    ...
    '''
    embryo_names = ['Sample04', 'Sample05', 'Sample06', 'Sample07', 'Sample08', 'Sample09', 'Sample10', 'Sample11', 'Sample12', 'Sample13', 'Sample14', 'Sample15',
                    'Sample16', 'Sample17', 'Sample18', 'Sample19', 'Sample20']
    '''
    embryo_names = ['Sample19', 'Sample20']
    root = r'E:\3Ddataset\input'
    target = r'E:\3Ddataset\output'
    ...
    #nifti2tiff_seperated(input, ouput, segmented=True)
