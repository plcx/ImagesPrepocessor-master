...
def pixel_distance_from0(binary_nuc):
...
def save_nuc_seg(para):
    ...
    for cell_name,cell_info in nuc_dict.items():
        ...
        cell_radius = int(cell_info[3]/8)#/8 small nuc. /4 normal nuc
    ...
    nib_stack = pixel_distance_from0(nib_stack)
